...
public final class NavHeaderMainBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView navHeaderDepartment;

  @NonNull
  public final TextView navHeaderName;

  private NavHeaderMainBinding(@NonNull LinearLayout rootView,
      @NonNull TextView navHeaderDepartment, @NonNull TextView navHeaderName) {
    this.rootView = rootView;
    this.navHeaderDepartment = navHeaderDepartment;
  ...
  public static NavHeaderMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.nav_header_department;
      TextView navHeaderDepartment = ViewBindings.findChildViewById(rootView, id);
      ...
      return new NavHeaderMainBinding((LinearLayout) rootView, navHeaderDepartment, navHeaderName);
    }
